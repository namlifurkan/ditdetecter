...
export const ROUND_CONFIGS: RoundConfig[] = [
  ...
  },
  {
    ...
    prompt: "TR: Çok tuhaf ama işe yarayacak reality show fikri öner!\n\nEN: Pitch a bizarre reality show idea that might actually work!",
    duration: GAME_CONFIG.ROUND_DURATION,
    maxLength: 140,
  },
  {
